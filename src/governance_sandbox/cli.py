...
def _load_scenario(path: Path) -> dict[str, Any]:
    ...
    if not isinstance(loaded, dict):
        return {}
    scenario_keys = ("proposal", "proposal_text", "proposal_markdown", "proposal_body", "proposal_body_markdown", "proposal_outline", "proposal_notes", "proposal_details", "prompt", "stakeholders", "stakeholder_list", "stakeholder_entries", "stakeholder_roster", "stakeholder_profiles", "stakeholder_group", "participants", "actors", "stakeholder_map", "stakeholder_presets", "scenario", "inputs", "report")
    nested_scenario_keys = ("proposal", "proposal_text", "proposal_markdown", "proposal_body", "proposal_body_markdown", "proposal_outline", "proposal_notes", "proposal_details", "prompt", "stakeholders", "stakeholder_list", "stakeholder_entries", "stakeholder_roster", "stakeholder_profiles", "stakeholder_group", "inputs", "report")
