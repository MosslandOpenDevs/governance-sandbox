...
def _resolve_report_basename(*report_sections: dict[str, Any], scenario: dict[str, Any]) -> str:
    ...
    configured = _pick(scenario, "report_basename", "report_file_stem", "report_output_file_stem", "report_stem", "report_name", "report_slug", "report_name_slug", "report_base", "report_bundle_key", "report_bundle_label", "report_bundle_alias", "report_bundle_handle", "report_bundle_name", "report_bundle_id", "report_bundle_ref", "report_bundle_title", "report_bundle_code", "report_bundle_basename", "report_bundle_tag", "report_output_label", "report_output_name", "report_output_slug", "report_output_id", "report_output_handle", "report_output_ref")
    if configured:
        return _slugify_report_basename(str(configured))
    titled = next((
