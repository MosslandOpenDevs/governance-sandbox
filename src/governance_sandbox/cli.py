...
def main() -> None:
    ...
    if args.command == "run":
        ...
        proposal = _normalize_proposal(args.proposal) or _normalize_proposal(_pick(scenario, "proposal", "proposal_text", "proposal_markdown", "proposal_body", "proposal_body_markdown", "proposal_outline", "proposal_notes", "proposal_details", "proposal_copy", "proposal_copy_markdown", "prompt")) or _normalize_proposal(_pick(inputs, "proposal", "proposal_text", "proposal_markdown", "proposal_body", "proposal_body_markdown", "proposal_outline", "proposal_notes", "proposal_details", "proposal_copy", "proposal_copy_markdown", "prompt")) or _normalize_proposal(_pick(scenario_inputs, "proposal", "proposal_text", "proposal_markdown", "proposal_body", "proposal_body_markdown", "proposal_outline", "proposal_notes", "proposal_details", "proposal_copy", "proposal_copy_markdown", "prompt")) or _normalize_proposal_from_mapping(scenario) or _normalize_proposal_from_mapping(inputs) or _normalize_proposal_from_mapping(scenario_inputs)
        ...
        result["scenario"] = {
            ...
            "report_title": _pick(scenario, "report_title", "report_heading") or _pick(scenario_meta, "report_title", "report_heading") or _pick(report_meta, "title", "heading") or _pick(top_level_output_report, "title", "heading") or _pick(inputs_report, "title", "heading") or _pick(scenario_inputs_report, "title", "heading"),
            "report_subtitle": _pick(scenario, "report_subtitle", "report_subheading") or _pick(scenario_meta, "report_subtitle", "report_subheading") or _pick(report_meta, "subtitle", "subheading") or _pick(top_level_output_report, "subtitle", "subheading") or _pick(inputs_report, "subtitle", "subheading") or _pick(scenario_inputs_report, "subtitle", "subheading"),
            "report_summary": _pick(report_meta, "report_summary", "report_description", "summary", "description", "abstract", "brief", "synopsis", "memo", "memo_summary", "executive_summary", "overview", "report_overview", "blurb", "report_blurb", "follow_up", "followup", "report_follow_up", "report_followup") or _pick(top_level_output_report, "report_summary", "report_description", "summary", "description", "abstract", "brief", "synopsis", "memo", "memo_summary", "executive_summary", "overview", "report_overview", "blurb", "report_blurb", "follow_up", "followup", "report_follow_up", "report_followup") or _pick(inputs_report, "report_summary", "report_description", "summary", "description", "abstract", "brief", "synopsis", "memo", "memo_summary", "executive_summary", "overview", "report_overview", "blurb", "report_blurb", "follow_up", "followup", "report_follow_up", "report_followup") or _pick(scenario_inputs_report, "report_summary", "report_description", "summary", "description", "abstract", "brief", "synopsis", "memo", "memo_summary", "executive_summary", "overview", "report_overview", "blurb", "report_blurb", "follow_up", "followup", "report_follow_up", "report_followup") or _pick(scenario, "report_summary", "report_description", "summary", "description", "brief", "synopsis", "memo", "memo_summary", "overview", "report_overview", "blurb", "report_blurb", "follow_up", "followup", "report_follow_up", "report_followup") or _pick(scenario_meta, "report_summary", "report_description", "summary", "description", "brief", "synopsis", "memo", "memo_summary", "overview", "report_overview", "blurb", "report_blurb", "follow_up", "followup", "report_follow_up", "report_followup"),
