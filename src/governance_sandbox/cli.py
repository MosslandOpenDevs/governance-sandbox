...
def _resolve_report_basename(*report_sections: dict[str, Any], scenario: dict[str, Any]) -> str:
    for report_meta in report_sections:
        ...
        configured = _pick(report_outputs, "basename", "bundle_basename", "bundle_name", "bundle_stem", "bundle_id", "bundle_key", "bundle_label", "bundle_ref", "bundle_title", "base_name", "file_basename", "file_stem", "stem", "output_basename", "output_name", "output_slug", "output_label", "output_id", "output_ref", "output_stem", "output_file_stem", "label", "bundle_slug", "report_slug", "report_name_slug", "base", "slug", "name") or _pick(report_meta, "basename", "bundle_basename", "bundle_name", "bundle_stem", "bundle_id", "bundle_key", "bundle_label", "bundle_ref", "bundle_title", "base_name", "file_basename", "file_stem", "stem", "output_basename", "output_name", "output_slug", "output_label", "output_id", "output_ref", "output_stem", "output_file_stem", "label", "bundle_slug", "report_slug", "report_name_slug", "base", "slug", "name")
        if configured:
            return _slugify_report_basename(str(configured))
    configured = _pick(scenario, "report_basename", "report_file_stem", "report_output_file_stem", "report_stem", "report_name", "report_slug", "report_name_slug", "report_base", "report_bundle_key", "report_bundle_label", "report_bundle_name", "report_bundle_id", "report_bundle_ref", "report_bundle_title", "report_bundle_code", "report_bundle_basename", "report_bundle_tag", "report_output_label", "report_output_name", "report_output_slug", "report_output_id")
    if configured:
        return _slugify_report_basename(str(configured))
    titled = next((
...
def main() -> None:
    ...
    if args.command == "run":
        ...
        result["scenario"] = {
            ...
            "report_basename": _pick(report_outputs, "basename", "bundle_basename", "bundle_name", "bundle_stem", "bundle_key", "bundle_label", "bundle_id", "bundle_title", "bundle_slug", "report_bundle_slug", "base_name", "file_basename", "file_stem", "stem", "output_basename", "output_name", "output_label", "output_id", "output_file_stem", "label", "report_slug", "report_name_slug", "base", "slug", "name") or _pick(top_level_output_report_outputs, "basename", "bundle_basename", "bundle_name", "bundle_stem", "bundle_key", "bundle_label", "bundle_id", "bundle_title", "bundle_slug", "report_bundle_slug", "base_name", "file_basename", "file_stem", "stem", "output_basename", "output_name", "output_label", "output_id", "output_file_stem", "label", "base", "slug", "name") or _pick(top_level_report_outputs, "basename", "bundle_basename", "bundle_name", "bundle_stem", "bundle_key", "bundle_label", "bundle_id", "bundle_title", "bundle_slug", "report_bundle_slug", "base_name", "file_basename", "file_stem", "stem", "output_basename", "output_name", "output_label", "output_id", "output_file_stem", "label", "base", "slug", "name") or _pick(report_meta, "basename", "bundle_basename", "bundle_name", "bundle_stem", "bundle_key", "bundle_label", "bundle_id", "bundle_title", "bundle_slug", "report_bundle_slug", "base_name", "file_basename", "file_stem", "stem", "output_basename", "output_name", "output_label", "output_id", "output_file_stem", "label", "base", "slug", "name") or _pick(top_level_output_report, "basename", "bundle_basename", "bundle_name", "bundle_stem", "bundle_key", "bundle_label", "bundle_id", "bundle_title", "bundle_slug", "report_bundle_slug", "base_name", "file_basename", "file_stem", "stem", "output_basename", "output_name", "output_label", "output_id", "output_file_stem", "label", "base", "slug", "name") or _pick(inputs_report, "basename", "bundle_basename", "bundle_name", "bundle_stem", "bundle_key", "bundle_label", "bundle_id", "bundle_title", "bundle_slug", "report_bundle_slug", "base_name", "file_basename", "file_stem", "stem", "output_basename", "output_name", "output_label", "output_id", "output_file_stem", "label", "base", "slug", "name") or _pick(scenario_inputs_report, "basename", "bundle_basename", "bundle_name", "bundle_stem", "bundle_key", "bundle_label", "bundle_id", "bundle_title", "bundle_slug", "report_bundle_slug", "base_name", "file_basename", "file_stem", "stem", "output_basename", "output_name", "output_label", "output_id", "output_file_stem", "label", "base", "slug", "name") or _pick(scenario, "report_basename", "report_file_stem", "report_output_file_stem", "report_stem", "report_name", "report_slug", "report_name_slug", "report_base", "report_bundle_key", "report_bundle_label", "report_bundle_name", "report_bundle_id", "report_bundle_ref", "report_bundle_code", "report_bundle_basename", "report_bundle_slug", "report_bundle_tag", "report_bundle_title", "report_output_label", "report_output_name", "report_output_slug", "report_output_id"),
