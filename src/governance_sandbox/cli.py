...
def _load_scenario(path: Path) -> dict[str, Any]:
    ...
    if not isinstance(loaded, dict):
        return {}
    for wrapper_key in ("scenario_payload", "scenario_data", "scenario_bundle", "scenario_document", "scenario_spec", "scenario_input", "scenario_inputs", "scenario_config"):
    ...
    if isinstance(value, dict):
        ...
        for name, preset in value.items():
            ...
            if isinstance(preset, dict):
                alias_name = _pick(preset, "name", "label", "title", "stakeholder")
...
def main() -> None:
    ...
    if args.command == "run":
        ...
        configured_report_dir = _pick(report_outputs, "dir", "bundle_dir", "report_dir", "output_dir", "output_folder", "directory", "output_directory") or _pick(top_level_report_outputs, "dir", "bundle_dir", "report_dir", "output_dir", "output_folder", "directory", "output_directory") or _pick(inputs_report_outputs, "dir", "bundle_dir", "report_dir", "output_dir", "output_folder", "directory", "output_directory") or _pick(scenario_inputs_report_outputs, "dir", "bundle_dir", "report_dir", "output_dir", "output_folder", "directory", "output_directory") or _pick(report_meta, "dir", "bundle_dir", "report_dir", "output_dir", "output_folder", "directory", "output_directory") or _pick(inputs_report, "dir", "bundle_dir", "report_dir", "output_dir", "output_folder", "directory", "output_directory") or _pick(scenario_inputs_report, "dir", "bundle_dir", "report_dir", "output_dir", "output_folder", "directory", "output_directory") or _pick(scenario, "report_dir", "report_directory", "report_output_dir", "report_output_directory", "report_output_folder", "report_bundle_dir", "report_bundle_directory", "bundle_dir")
        if args.report_dir:
