...
def main() -> None:
    ...
    if args.command == "run":
        ...
        result["scenario"] = {
            ...
            "report_summary": _pick(report_meta, "report_summary", "summary", "description", "abstract", "brief", "memo_summary", "executive_summary", "overview", "report_overview") or _pick(scenario, "report_summary", "brief", "memo_summary", "overview", "report_overview") or _pick(scenario_meta, "report_summary", "description", "brief", "memo_summary", "overview", "report_overview"),
            "report_audience": ", ".join(_normalize_string_list(_pick(report_meta, "audience", "audiences", "readers", "targets", "report_audience", "report_audiences", "report_readers", "report_targets") or _pick(scenario, "report_audience", "report_audiences", "report_readers", "report_targets", "audience", "audiences") or _pick(scenario_meta, "report_audience", "report_audiences", "report_readers", "report_targets", "audience", "audiences"))) or None,
