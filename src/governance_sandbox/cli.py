...
def _load_scenario(path: Path) -> dict[str, Any]:
    ...
    if not isinstance(loaded, dict):
        return {}
    scenario_keys = ("proposal", "proposal_text", "proposal_markdown", "proposal_body_markdown", "prompt", "stakeholders", "stakeholder_roster", "stakeholder_profiles", "participants", "actors", "stakeholder_map", "stakeholder_presets", "scenario", "inputs", "report")
    nested_scenario_keys = ("proposal", "proposal_text", "proposal_markdown", "proposal_body_markdown", "prompt", "stakeholders", "stakeholder_roster", "stakeholder_profiles", "participants", "actors", "stakeholder_map", "stakeholder_presets", "inputs", "report")
...
def _proposal_parts_from_mapping(value: dict[str, Any]) -> list[str]:
    ...
    body = _pick(value, "body", "text", "content", "proposal", "proposal_text", "proposal_markdown", "proposal_body_markdown", "prompt", "message", "proposal_body")
    parts = [
        str(item).strip()
...
def main() -> None:
    ...
    if args.command == "run":
        ...
        proposal = _normalize_proposal(args.proposal) or _normalize_proposal(_pick(scenario, "proposal", "proposal_text", "proposal_markdown", "proposal_body_markdown", "prompt")) or _normalize_proposal(_pick(inputs, "proposal", "proposal_text", "proposal_markdown", "proposal_body_markdown", "prompt")) or _normalize_proposal(_pick(scenario_inputs, "proposal", "proposal_text", "proposal_markdown", "proposal_body_markdown", "prompt")) or _normalize_proposal_from_mapping(scenario) or _normalize_proposal_from_mapping(inputs) or _normalize_proposal_from_mapping(scenario_inputs)
        ...
        result["scenario"] = {
            ...
            "report_audience": ", ".join(_normalize_string_list(_pick(report_meta, "audience", "audiences", "readers", "reviewers", "viewers", "targets", "report_audience", "report_audiences", "report_readers", "report_reviewers", "report_viewers", "report_targets") or _pick(inputs_report, "audience", "audiences", "readers", "reviewers", "viewers", "targets", "report_audience", "report_audiences", "report_readers", "report_reviewers", "report_viewers", "report_targets") or _pick(scenario_inputs_report, "audience", "audiences", "readers", "reviewers", "viewers", "targets", "report_audience", "report_audiences", "report_readers", "report_reviewers", "report_viewers", "report_targets") or _pick(scenario, "report_audience", "report_audiences", "report_readers", "report_viewers", "report_targets", "audience", "audiences", "viewers") or _pick(scenario_meta, "report_audience", "report_audiences", "report_readers", "report_viewers", "report_targets", "audience", "audiences", "viewers"))) or None,
