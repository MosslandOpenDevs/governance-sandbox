...
def main() -> None:
    ...
    if args.command == "run":
        ...
        result["scenario"] = {
            ...
            "report_summary": _pick(report_meta, "summary", "description", "abstract", "brief", "memo_summary", "executive_summary") or _pick(scenario, "report_summary", "brief", "memo_summary") or _pick(scenario_meta, "report_summary", "description", "brief", "memo_summary"),
