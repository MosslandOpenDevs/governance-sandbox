...
def main() -> None:
    ...
    if args.command == "run":
        ...
        result["scenario"] = {
            ...
            "report_basename": _pick(report_outputs, "basename", "bundle_basename", "bundle_name", "base_name", "file_basename", "file_stem", "stem", "output_basename", "output_name", "base", "slug", "name") or _pick(top_level_output_report_outputs, "basename", "bundle_basename", "bundle_name", "base_name", "file_basename", "file_stem", "stem", "output_basename", "output_name", "base", "slug", "name") or _pick(top_level_report_outputs, "basename", "bundle_basename", "bundle_name", "base_name", "file_basename", "file_stem", "stem", "output_basename", "output_name", "base", "slug", "name") or _pick(report_meta, "basename", "bundle_basename", "bundle_name", "base_name", "file_basename", "file_stem", "stem", "output_basename", "output_name", "base", "slug", "name") or _pick(top_level_output_report, "basename", "bundle_basename", "bundle_name", "base_name", "file_basename", "file_stem", "stem", "output_basename", "output_name", "base", "slug", "name") or _pick(inputs_report, "basename", "bundle_basename", "bundle_name", "base_name", "file_basename", "file_stem", "stem", "output_basename", "output_name", "base", "slug", "name") or _pick(scenario_inputs_report, "basename", "bundle_basename", "bundle_name", "base_name", "file_basename", "file_stem", "stem", "output_basename", "output_name", "base", "slug", "name") or _pick(scenario, "report_basename", "report_file_stem", "report_stem", "report_name", "report_base"),
