...
def main() -> None:
    ...
    if args.command == "run":
        ...
        result["scenario"] = {
            ...
            "report_owner": ", ".join(_normalize_string_list(_pick(report_meta, "owner", "owners", "maintainer", "maintainers", "author", "authors", "byline", "bylines", "report_owner", "report_owners", "report_author", "report_authors", "report_byline", "report_bylines") or _pick(inputs_report, "owner", "owners", "maintainer", "maintainers", "author", "authors", "byline", "bylines", "report_owner", "report_owners", "report_author", "report_authors", "report_byline", "report_bylines") or _pick(scenario_inputs_report, "owner", "owners", "maintainer", "maintainers", "author", "authors", "byline", "bylines", "report_owner", "report_owners", "report_author", "report_authors", "report_byline", "report_bylines") or _pick(scenario, "report_owner", "report_owners", "report_author", "report_authors", "report_byline", "report_bylines", "owner", "owners", "maintainer", "maintainers", "author", "authors", "byline", "bylines") or _pick(scenario_meta, "report_owner", "report_owners", "report_author", "report_authors", "report_byline", "report_bylines", "owner", "owners", "maintainer", "maintainers", "author", "authors", "byline", "bylines"))) or None,
