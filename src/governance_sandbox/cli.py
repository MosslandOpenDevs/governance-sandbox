...
def _resolve_report_basename(*report_sections: dict[str, Any], scenario: dict[str, Any]) -> str:
    for report_meta in report_sections:
        ...
        configured = _pick(report_outputs, "basename", "bundle_basename", "bundle_name", "bundle_stem", "bundle_id", "bundle_label", "base_name", "file_basename", "file_stem", "stem", "output_basename", "output_name", "output_slug", "bundle_slug", "report_slug", "report_name_slug", "base", "slug", "name") or _pick(report_meta, "basename", "bundle_basename", "bundle_name", "bundle_stem", "bundle_id", "bundle_label", "base_name", "file_basename", "file_stem", "stem", "output_basename", "output_name", "output_slug", "bundle_slug", "report_slug", "report_name_slug", "base", "slug", "name")
        if configured:
