...
def _resolve_report_basename(*report_sections: dict[str, Any], scenario: dict[str, Any]) -> str:
    ...
    configured = _pick(scenario, "report_basename", "report_file_stem", "report_output_file_stem", "report_stem", "report_name", "report_slug", "report_name_slug", "report_base", "report_bundle_key", "report_bundle_label", "report_bundle_name", "report_bundle_id", "report_bundle_title")
    if configured:
        return _slugify_report_basename(str(configured))
    titled = next((
