...
def _resolve_report_basename(report_meta: dict[str, Any], scenario: dict[str, Any]) -> str:
    configured = _pick(report_meta, "basename", "file_basename", "output_basename", "output_name", "slug", "name") or _pick(scenario, "report_basename", "report_name")
    if configured:
...
def main() -> None:
    ...
    if args.command == "run":
        ...
        result["scenario"] = {
            ...
            "report_summary": _pick(report_meta, "summary", "description", "abstract", "brief", "memo_summary", "executive_summary", "overview") or _pick(scenario, "report_summary", "brief", "memo_summary", "overview") or _pick(scenario_meta, "report_summary", "description", "brief", "memo_summary", "overview"),
