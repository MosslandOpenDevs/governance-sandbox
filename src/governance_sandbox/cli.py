...
def main() -> None:
    ...
    if args.command == "run":
        ...
        result["scenario"] = {
            ...
            "report_summary": _pick(report_meta, "report_summary", "summary", "description", "abstract", "brief", "memo", "memo_summary", "executive_summary", "overview", "report_overview") or _pick(scenario, "report_summary", "summary", "brief", "memo", "memo_summary", "overview", "report_overview") or _pick(scenario_meta, "report_summary", "summary", "description", "brief", "memo", "memo_summary", "overview", "report_overview"),
