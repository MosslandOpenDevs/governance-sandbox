...
def _resolve_report_basename(*report_sections: dict[str, Any], scenario: dict[str, Any]) -> str:
    for report_meta in report_sections:
        ...
        configured = _pick(report_outputs, "basename", "bundle_basename", "bundle_name", "bundle_stem", "bundle_id", "base_name", "file_basename", "file_stem", "stem", "output_basename", "output_name", "output_slug", "bundle_slug", "report_slug", "report_name_slug", "base", "slug", "name") or _pick(report_meta, "basename", "bundle_basename", "bundle_name", "bundle_stem", "bundle_id", "base_name", "file_basename", "file_stem", "stem", "output_basename", "output_name", "output_slug", "bundle_slug", "report_slug", "report_name_slug", "base", "slug", "name")
        if configured:
            return _slugify_report_basename(str(configured))
    configured = _pick(scenario, "report_basename", "report_file_stem", "report_stem", "report_name", "report_slug", "report_name_slug", "report_base")
    if configured:
        return _slugify_report_basename(str(configured))
    titled = next((
...
def main() -> None:
    ...
    if args.command == "run":
        ...
        result["scenario"] = {
            ...
            "report_basename": _pick(report_outputs, "basename", "bundle_basename", "bundle_name", "bundle_stem", "base_name", "file_basename", "file_stem", "stem", "output_basename", "output_name", "report_slug", "report_name_slug", "base", "slug", "name") or _pick(top_level_output_report_outputs, "basename", "bundle_basename", "bundle_name", "bundle_stem", "base_name", "file_basename", "file_stem", "stem", "output_basename", "output_name", "base", "slug", "name") or _pick(top_level_report_outputs, "basename", "bundle_basename", "bundle_name", "bundle_stem", "base_name", "file_basename", "file_stem", "stem", "output_basename", "output_name", "base", "slug", "name") or _pick(report_meta, "basename", "bundle_basename", "bundle_name", "bundle_stem", "base_name", "file_basename", "file_stem", "stem", "output_basename", "output_name", "base", "slug", "name") or _pick(top_level_output_report, "basename", "bundle_basename", "bundle_name", "bundle_stem", "base_name", "file_basename", "file_stem", "stem", "output_basename", "output_name", "base", "slug", "name") or _pick(inputs_report, "basename", "bundle_basename", "bundle_name", "bundle_stem", "base_name", "file_basename", "file_stem", "stem", "output_basename", "output_name", "base", "slug", "name") or _pick(scenario_inputs_report, "basename", "bundle_basename", "bundle_name", "bundle_stem", "base_name", "file_basename", "file_stem", "stem", "output_basename", "output_name", "base", "slug", "name") or _pick(scenario, "report_basename", "report_file_stem", "report_stem", "report_name", "report_slug", "report_name_slug", "report_base"),
