...
def main() -> None:
    ...
    if args.command == "run":
        ...
        result["scenario"] = {
            ...
            "report_summary": _pick(report_meta, "report_summary", "summary", "description", "abstract", "brief", "synopsis", "memo", "memo_summary", "executive_summary", "overview", "report_overview", "blurb", "report_blurb") or _pick(top_level_output_report, "report_summary", "summary", "description", "abstract", "brief", "synopsis", "memo", "memo_summary", "executive_summary", "overview", "report_overview", "blurb", "report_blurb") or _pick(inputs_report, "report_summary", "summary", "description", "abstract", "brief", "synopsis", "memo", "memo_summary", "executive_summary", "overview", "report_overview", "blurb", "report_blurb") or _pick(scenario_inputs_report, "report_summary", "summary", "description", "abstract", "brief", "synopsis", "memo", "memo_summary", "executive_summary", "overview", "report_overview", "blurb", "report_blurb") or _pick(scenario, "report_summary", "summary", "brief", "synopsis", "memo", "memo_summary", "overview", "report_overview", "blurb", "report_blurb") or _pick(scenario_meta, "report_summary", "summary", "description", "brief", "synopsis", "memo", "memo_summary", "overview", "report_overview", "blurb", "report_blurb"),
