...
def _load_scenario(path: Path) -> dict[str, Any]:
    ...
    if not isinstance(loaded, dict):
        return {}
    scenario_keys = ("proposal", "proposal_text", "proposal_markdown", "proposal_body", "proposal_body_markdown", "proposal_outline", "proposal_notes", "proposal_details", "prompt", "stakeholders", "stakeholder_list", "stakeholder_entries", "stakeholder_roster", "stakeholder_profiles", "stakeholder_group", "participants", "actors", "stakeholder_map", "stakeholder_presets", "stakeholder_catalog", "scenario", "inputs", "report")
    nested_scenario_keys = ("proposal", "proposal_text", "proposal_markdown", "proposal_body", "proposal_body_markdown", "proposal_outline", "proposal_notes", "proposal_details", "prompt", "stakeholders", "stakeholder_list", "stakeholder_entries", "stakeholder_roster", "stakeholder_profiles", "stakeholder_group", "stakeholder_catalog", "inputs", "report")
    for wrapper_key in ("scenario_payload", "scenario_data", "scenario_bundle", "scenario_document", "scenario_dossier", "scenario_dossier_bundle", "scenario_spec", "scenario_input", "scenario_inputs", "scenario_input_bundle", "scenario_packet", "scenario_packet_bundle", "scenario_config", "scenario_plan", "scenario_manifest", "scenario_manifest_bundle", "scenario_outline", "scenario_brief", "scenario_blueprint", "scenario_deck", "scenario_deck_bundle", "scenario_rehearsal", "scenario_rehearsal_bundle", "scenario_sheet", "scenario_sheet_bundle", "scenario_case", "scenario_case_bundle", "scenario_case_pack", "scenario_case_pack_bundle", "scenario_storyboard", "scenario_storyboard_bundle", "scenario_package", "scenario_record", "scenario_archive", "scenario_fixture", "scenario_playbook", "scenario_playbook_bundle", "scenario_session", "scenario_session_bundle", "scenario_replay_bundle", "scenario_lab", "scenario_lab_bundle", "scenario_workshop", "scenario_workshop_bundle", "scenario_workbench", "scenario_workbench_bundle", "scenario_workbook", "scenario_workbook_bundle", "scenario_demo", "scenario_demo_bundle", "scenario_demo_pack", "scenario_demo_pack_bundle", "scenario_rehearsal_pack", "scenario_rehearsal_pack_bundle", "scenario_showcase", "scenario_showcase_bundle", "scenario_notebook", "scenario_notebook_bundle", "scenario_review_pack", "scenario_review_pack_bundle", "scenario_studio", "scenario_studio_bundle", "scenario_workspace", "scenario_workspace_bundle", "scenario_stage", "scenario_stage_bundle", "scenario_stage_pack", "scenario_stage_pack_bundle", "scenario_report_bundle", "scenario_report_bundle_pack", "scenario_portfolio", "scenario_portfolio_bundle", "scenario_workflow", "scenario_workflow_bundle", "scenario_playground", "scenario_playground_bundle", "scenario_journal", "scenario_journal_bundle", "scenario_casefile", "scenario_casefile_bundle", "rehearsal", "rehearsal_bundle"):
...
def _proposal_parts_from_mapping(value: dict[str, Any]) -> list[str]:
    ...
    body = _pick(value, "body", "text", "content", "proposal", "proposal_text", "proposal_markdown", "proposal_body", "proposal_body_markdown", "proposal_outline", "proposal_notes", "proposal_details", "proposal_description", "proposal_desc", "proposal_copy", "proposal_copy_markdown", "proposal_copy_md", "prompt", "message", "proposal_body")
    parts = [
        str(item).strip()
...
def _resolve_text_input(value: Any, *, scenario_file: str | None = None) -> str | None:
    if isinstance(value, dict):
        file_value = _pick(
            ...
            "proposal_copy_file",
            "proposal_input_file",
            "proposal_input_markdown_file",
            "proposal_input_markdown_path",
            "proposal_input_md_file",
            "proposal_input_md_path",
            "proposal_input_path",
            "proposal_copy_path",
            "proposal_text_file",
            "proposal_copy_file",
            "proposal_copy_source",
            "body_file",
            "body_path",
        )
        if file_value:
            ...
            if not candidate.is_absolute() and scenario_file and scenario_file != "-":
                candidate = Path(scenario_file).resolve().parent / candidate
            if not candidate.exists():
                raise SystemExit(f"Referenced text file does not exist: {candidate}")
...
def _resolve_proposal_candidate(mapping: dict[str, Any], *, scenario_file: str | None = None) -> str | None:
    ...
    proposal_file = _pick(mapping, "proposal_file", "proposal_path", "proposal_src", "proposal_source", "proposal_href", "proposal_link", "proposal_uri", "proposal_url", "proposal_markdown_file", "proposal_md_file", "proposal_markdown_path", "proposal_md_path", "proposal_copy_file", "proposal_copy_path", "proposal_copy_source", "proposal_input_file", "proposal_input_markdown_file", "proposal_input_markdown_path", "proposal_input_md_file", "proposal_input_md_path", "proposal_input_path", "proposal_text_file", "proposal_body_file", "body_path")
    if proposal_file:
...
def _resolve_report_basename(*report_sections: dict[str, Any], scenario: dict[str, Any]) -> str:
    for report_meta in report_sections:
        ...
        configured = _pick(report_outputs, "basename", "bundle_basename", "bundle_name", "bundle_stem", "bundle_id", "bundle_key", "bundle_label", "bundle_handle", "bundle_ref", "bundle_title", "base_name", "file_basename", "file_stem", "stem", "output_basename", "output_name", "output_slug", "output_label", "output_id", "output_key", "output_handle", "output_ref", "output_code", "output_stem", "output_file_stem", "label", "bundle_slug", "report_slug", "report_name_slug", "base", "slug", "name") or _pick(report_meta, "basename", "bundle_basename", "bundle_name", "bundle_stem", "bundle_id", "bundle_key", "bundle_label", "bundle_handle", "bundle_ref", "bundle_title", "base_name", "file_basename", "file_stem", "stem", "output_basename", "output_name", "output_slug", "output_label", "output_id", "output_key", "output_handle", "output_ref", "output_code", "output_stem", "output_file_stem", "label", "bundle_slug", "report_slug", "report_name_slug", "base", "slug", "name")
        if configured:
            return _slugify_report_basename(str(configured))
    configured = _pick(scenario, "report_basename", "report_file_stem", "report_output_file_stem", "report_output_basename", "report_stem", "report_name", "report_slug", "report_name_slug", "report_base", "report_bundle_key", "report_bundle_label", "report_bundle_alias", "report_bundle_handle", "report_bundle_name", "report_bundle_id", "report_bundle_ref", "report_bundle_title", "report_bundle_code", "report_bundle_stem", "report_bundle_basename", "report_bundle_tag", "report_output_label", "report_output_name", "report_output_slug", "report_output_id", "report_output_key", "report_output_handle", "report_output_ref", "report_output_code", "report_output_tag")
    if configured:
        return _slugify_report_basename(str(configured))
    titled = next((
...
def _render_markdown_report(result: dict[str, Any]) -> str:
    ...
    if scenario.get("report_reviewers"):
        lines.extend(["## Report reviewers", scenario["report_reviewers"], ""])
...
def _render_html_report(result: dict[str, Any]) -> str:
    ...
    scenario_panel = ""
    if any(scenario.get(key) for key in ("name", "context", "report_title", "report_subtitle", "report_summary", "report_audience", "report_owner", "report_reviewers", "report_subject", "report_priority", "scenario_file", "scenario_format", "tags")):
        ...
        if scenario.get("report_reviewers"):
            scenario_bits.append(f'<p><strong>Report reviewers:</strong> {escape(scenario["report_reviewers"])}</p>')
        if scenario.get("report_subject"):
...
def main() -> None:
    ...
    run_cmd.add_argument("--scenario-file", "--scenario", "--proposal-file", "--scenario-source", "--scenario-file-path", dest="scenario_file", help="Path to a JSON/JSONC or YAML scenario file")
    run_cmd.add_argument("--report-markdown", "--report-md", "--report-markdown-file", "--report-markdown-path", dest="report_markdown", help="Write a markdown report to this path")
    run_cmd.add_argument("--report-html", "--report-htm", "--report-html-file", "--report-html-path", dest="report_html", help="Write an HTML report to this path")
    run_cmd.add_argument("--report-json", "--report-json-path", help="Write the JSON result to this path")
    run_cmd.add_argument("--report-dir", "--reports-dir", "--report-bundle-dir", "--report-output-dir", "--report-output-folder", dest="report_dir", help="Write report.json, report.md, and report.html into this directory")
    ...
    if args.command == "run":
        ...
        if stakeholder_input:
            ...
            stakeholders = _normalize_stakeholders(
                _pick(scenario, "stakeholders", "stakeholder_list", "stakeholder_entries", "stakeholder_roster", "stakeholder_profiles", "stakeholder_group", "participants", "actors", "stakeholder_groups", "voters", "stakeholder_map", "stakeholder_presets", "stakeholder_catalog", "preset_groups", "stakeholder_preset_map", "stakeholder_trait_map", "stakeholder_types", "trait_map", "persona_map", "stakeholder_traits", "stakeholder_personas", "traits", "personas")
                or _pick(inputs, "stakeholders", "stakeholder_list", "stakeholder_entries", "stakeholder_roster", "stakeholder_profiles", "stakeholder_group", "participants", "actors", "stakeholder_groups", "voters", "stakeholder_map", "stakeholder_presets", "stakeholder_catalog", "preset_groups", "stakeholder_preset_map", "stakeholder_trait_map", "stakeholder_types", "trait_map", "persona_map", "stakeholder_traits", "stakeholder_personas", "traits", "personas")
                or _pick(scenario_inputs, "stakeholders", "stakeholder_list", "stakeholder_entries", "stakeholder_roster", "stakeholder_profiles", "stakeholder_group", "participants", "actors", "stakeholder_groups", "voters", "stakeholder_map", "stakeholder_presets", "stakeholder_catalog", "preset_groups", "stakeholder_preset_map", "stakeholder_trait_map", "stakeholder_types", "trait_map", "persona_map", "stakeholder_traits", "stakeholder_personas", "traits", "personas")
            )
        if not proposal:
        ...
        result["scenario"] = {
            ...
            "report_subtitle": _pick(scenario, "report_subtitle", "report_subheading", "report_tagline") or _pick(scenario_meta, "report_subtitle", "report_subheading", "report_tagline") or _pick(report_meta, "subtitle", "subheading", "tagline") or _pick(top_level_output_report, "subtitle", "subheading", "tagline") or _pick(inputs_report, "subtitle", "subheading", "tagline") or _pick(scenario_inputs_report, "subtitle", "subheading", "tagline"),
            "report_summary": _pick(report_meta, "report_summary", "report_description", "summary", "description", "abstract", "brief", "synopsis", "memo", "memo_summary", "executive_summary", "overview", "report_overview", "briefing", "report_briefing", "blurb", "report_blurb", "purpose", "goal", "goals", "report_goal", "report_goals", "note", "notes", "report_note", "report_notes", "follow_up", "followup", "report_follow_up", "report_followup", "takeaway", "report_takeaway", "digest", "report_digest", "report_synopsis") or _pick(top_level_output_report, "report_summary", "report_description", "summary", "description", "abstract", "brief", "synopsis", "memo", "memo_summary", "executive_summary", "overview", "report_overview", "briefing", "report_briefing", "blurb", "report_blurb", "purpose", "goal", "goals", "report_goal", "report_goals", "note", "notes", "report_note", "report_notes", "follow_up", "followup", "report_follow_up", "report_followup", "takeaway", "report_takeaway", "digest", "report_digest", "report_synopsis") or _pick(inputs_report, "report_summary", "report_description", "summary", "description", "abstract", "brief", "synopsis", "memo", "memo_summary", "executive_summary", "overview", "report_overview", "briefing", "report_briefing", "blurb", "report_blurb", "purpose", "goal", "goals", "report_goal", "report_goals", "note", "notes", "report_note", "report_notes", "follow_up", "followup", "report_follow_up", "report_followup", "takeaway", "report_takeaway", "digest", "report_digest", "report_synopsis") or _pick(scenario_inputs_report, "report_summary", "report_description", "summary", "description", "abstract", "brief", "synopsis", "memo", "memo_summary", "executive_summary", "overview", "report_overview", "briefing", "report_briefing", "blurb", "report_blurb", "purpose", "goal", "goals", "report_goal", "report_goals", "note", "notes", "report_note", "report_notes", "follow_up", "followup", "report_follow_up", "report_followup", "takeaway", "report_takeaway", "digest", "report_digest", "report_synopsis") or _pick(scenario, "report_summary", "report_description", "summary", "description", "abstract", "brief", "synopsis", "memo", "memo_summary", "executive_summary", "overview", "report_overview", "briefing", "report_briefing", "blurb", "report_blurb", "purpose", "goal", "goals", "report_goal", "report_goals", "follow_up", "followup", "report_follow_up", "report_followup", "takeaway", "report_takeaway", "digest", "report_digest") or _pick(scenario_meta, "report_summary", "report_description", "summary", "description", "abstract", "brief", "synopsis", "memo", "memo_summary", "executive_summary", "overview", "report_overview", "briefing", "report_briefing", "blurb", "report_blurb", "purpose", "goal", "goals", "report_goal", "report_goals", "note", "notes", "report_note", "report_notes", "follow_up", "followup", "report_follow_up", "report_followup", "takeaway", "report_takeaway", "digest", "report_digest", "report_synopsis"),
            "report_basename": _pick(report_outputs, "basename", "bundle_basename", "bundle_name", "bundle_stem", "bundle_key", "bundle_label", "bundle_alias", "bundle_handle", "bundle_id", "bundle_title", "bundle_slug", "report_bundle_slug", "base_name", "file_basename", "file_stem", "stem", "output_basename", "output_name", "output_label", "output_id", "output_key", "output_handle", "output_ref", "output_file_stem", "output_tag", "label", "report_slug", "report_name_slug", "base", "slug", "name") or _pick(top_level_output_report_outputs, "basename", "bundle_basename", "bundle_name", "bundle_stem", "bundle_key", "bundle_label", "bundle_alias", "bundle_handle", "bundle_id", "bundle_title", "bundle_slug", "report_bundle_slug", "base_name", "file_basename", "file_stem", "stem", "output_basename", "output_name", "output_label", "output_id", "output_key", "output_handle", "output_ref", "output_file_stem", "output_tag", "label", "base", "slug", "name") or _pick(top_level_report_outputs, "basename", "bundle_basename", "bundle_name", "bundle_stem", "bundle_key", "bundle_label", "bundle_alias", "bundle_handle", "bundle_id", "bundle_title", "bundle_slug", "report_bundle_slug", "base_name", "file_basename", "file_stem", "stem", "output_basename", "output_name", "output_label", "output_id", "output_key", "output_handle", "output_ref", "output_file_stem", "output_tag", "label", "base", "slug", "name") or _pick(report_meta, "basename", "bundle_basename", "bundle_name", "bundle_stem", "bundle_key", "bundle_label", "bundle_alias", "bundle_handle", "bundle_id", "bundle_title", "bundle_slug", "report_bundle_slug", "base_name", "file_basename", "file_stem", "stem", "output_basename", "output_name", "output_label", "output_id", "output_key", "output_handle", "output_ref", "output_file_stem", "output_tag", "label", "base", "slug", "name") or _pick(top_level_output_report, "basename", "bundle_basename", "bundle_name", "bundle_stem", "bundle_key", "bundle_label", "bundle_alias", "bundle_handle", "bundle_id", "bundle_title", "bundle_slug", "report_bundle_slug", "base_name", "file_basename", "file_stem", "stem", "output_basename", "output_name", "output_label", "output_id", "output_key", "output_handle", "output_ref", "output_file_stem", "output_tag", "label", "base", "slug", "name") or _pick(inputs_report, "basename", "bundle_basename", "bundle_name", "bundle_stem", "bundle_key", "bundle_label", "bundle_alias", "bundle_handle", "bundle_id", "bundle_title", "bundle_slug", "report_bundle_slug", "base_name", "file_basename", "file_stem", "stem", "output_basename", "output_name", "output_label", "output_id", "output_key", "output_handle", "output_ref", "output_file_stem", "output_tag", "label", "base", "slug", "name") or _pick(scenario_inputs_report, "basename", "bundle_basename", "bundle_name", "bundle_stem", "bundle_key", "bundle_label", "bundle_alias", "bundle_handle", "bundle_id", "bundle_title", "bundle_slug", "report_bundle_slug", "base_name", "file_basename", "file_stem", "stem", "output_basename", "output_name", "output_label", "output_id", "output_key", "output_handle", "output_ref", "output_file_stem", "output_tag", "label", "base", "slug", "name") or _pick(scenario, "report_basename", "report_file_stem", "report_output_file_stem", "report_output_basename", "report_stem", "report_name", "report_slug", "report_name_slug", "report_base", "report_bundle_key", "report_bundle_label", "report_bundle_alias", "report_bundle_handle", "report_bundle_name", "report_bundle_id", "report_bundle_ref", "report_bundle_code", "report_bundle_stem", "report_bundle_basename", "report_bundle_slug", "report_bundle_tag", "report_bundle_title", "report_output_label", "report_output_name", "report_output_slug", "report_output_id", "report_output_key", "report_output_handle", "report_output_ref", "report_output_code", "report_output_tag"),
            "report_audience": ", ".join(_normalize_string_list(_pick(report_meta, "audience", "audiences", "reader", "readers", "reviewer", "reviewers", "viewer", "viewers", "watcher", "watchers", "target", "targets", "review_team", "review_teams", "report_audience", "report_audiences", "report_reader", "report_readers", "report_reviewer", "report_reviewers", "report_viewer", "report_viewers", "report_watcher", "report_watchers", "report_target", "report_targets", "report_review_team", "report_review_teams") or _pick(inputs_report, "audience", "audiences", "reader", "readers", "reviewer", "reviewers", "viewer", "viewers", "watcher", "watchers", "target", "targets", "review_team", "review_teams", "report_audience", "report_audiences", "report_reader", "report_readers", "report_reviewer", "report_reviewers", "report_viewer", "report_viewers", "report_watcher", "report_watchers", "report_target", "report_targets", "report_review_team", "report_review_teams") or _pick(scenario_inputs_report, "audience", "audiences", "reader", "readers", "reviewer", "reviewers", "viewer", "viewers", "watcher", "watchers", "target", "targets", "review_team", "review_teams", "report_audience", "report_audiences", "report_reader", "report_readers", "report_reviewer", "report_reviewers", "report_viewer", "report_viewers", "report_watcher", "report_watchers", "report_target", "report_targets", "report_review_team", "report_review_teams") or _pick(scenario, "report_audience", "report_audiences", "report_reader", "report_readers", "report_reviewer", "report_reviewers", "report_viewer", "report_viewers", "report_watcher", "report_watchers", "report_target", "report_targets", "report_review_team", "report_review_teams", "audience", "audiences", "reader", "reviewer", "viewer", "watcher", "watchers", "target", "review_team", "review_teams") or _pick(scenario_meta, "report_audience", "report_audiences", "report_reader", "report_readers", "report_reviewer", "report_reviewers", "report_viewer", "report_viewers", "report_watcher", "report_watchers", "report_target", "report_targets", "report_review_team", "report_review_teams", "audience", "audiences", "reader", "reviewer", "viewer", "watcher", "watchers", "target", "review_team", "review_teams"))) or None,
            "report_owner": ", ".join(_normalize_string_list(_pick(report_meta, "owner", "owners", "maintainer", "maintainers", "lead", "leads", "author", "authors", "byline", "bylines", "report_owner", "report_owners", "report_lead", "report_leads", "report_author", "report_authors", "report_byline", "report_bylines") or _pick(inputs_report, "owner", "owners", "maintainer", "maintainers", "lead", "leads", "author", "authors", "byline", "bylines", "report_owner", "report_owners", "report_lead", "report_leads", "report_author", "report_authors", "report_byline", "report_bylines") or _pick(scenario_inputs_report, "owner", "owners", "maintainer", "maintainers", "lead", "leads", "author", "authors", "byline", "bylines", "report_owner", "report_owners", "report_lead", "report_leads", "report_author", "report_authors", "report_byline", "report_bylines") or _pick(scenario, "report_owner", "report_owners", "report_lead", "report_leads", "report_author", "report_authors", "report_byline", "report_bylines", "owner", "owners", "maintainer", "maintainers", "lead", "leads", "author", "authors", "byline", "bylines") or _pick(scenario_meta, "report_owner", "report_owners", "report_lead", "report_leads", "report_author", "report_authors", "report_byline", "report_bylines", "owner", "owners", "maintainer", "maintainers", "lead", "leads", "author", "authors", "byline", "bylines"))) or None,
            "report_reviewers": ", ".join(_normalize_string_list(_pick(report_meta, "reviewers", "reviewer", "reviewer_list", "reviewer_lists", "review_team", "review_teams", "report_reviewers", "report_reviewer", "report_reviewer_list", "report_reviewer_lists", "report_review_team", "report_review_teams") or _pick(inputs_report, "reviewers", "reviewer", "reviewer_list", "reviewer_lists", "review_team", "review_teams", "report_reviewers", "report_reviewer", "report_reviewer_list", "report_reviewer_lists", "report_review_team", "report_review_teams") or _pick(scenario_inputs_report, "reviewers", "reviewer", "reviewer_list", "reviewer_lists", "review_team", "review_teams", "report_reviewers", "report_reviewer", "report_reviewer_list", "report_reviewer_lists", "report_review_team", "report_review_teams") or _pick(scenario, "report_reviewers", "report_reviewer", "report_reviewer_list", "report_reviewer_lists", "report_review_team", "report_review_teams", "reviewers", "reviewer", "reviewer_list", "reviewer_lists", "review_team", "review_teams") or _pick(scenario_meta, "report_reviewers", "report_reviewer", "report_reviewer_list", "report_reviewer_lists", "report_review_team", "report_review_teams", "reviewers", "reviewer", "reviewer_list", "reviewer_lists", "review_team", "review_teams"))) or None,
        ...
        configured_report_dir = _pick(report_outputs, "dir", "bundle_dir", "report_dir", "reports_dir", "reports_directory", "report_directory", "output_dir", "report_output_directory", "report_output_dir", "output_folder", "reports_folder", "directory", "bundle_directory", "output_directory", "artifact_dir", "artifacts_dir", "artifacts_directory", "folder", "bundle_folder", "root", "report_root", "output_root", "report_output_root", "report_bundle_root", "artifacts_root") or _pick(top_level_output_report_outputs, "dir", "bundle_dir", "report_dir", "reports_dir", "reports_directory", "report_directory", "output_dir", "report_output_directory", "report_output_dir", "output_folder", "reports_folder", "directory", "bundle_directory", "output_directory", "artifact_dir", "artifacts_dir", "artifacts_directory", "folder", "bundle_folder", "root", "report_root", "output_root", "report_output_root", "report_bundle_root", "artifacts_root") or _pick(top_level_report_outputs, "dir", "bundle_dir", "report_dir", "reports_dir", "reports_directory", "report_directory", "output_dir", "report_output_directory", "report_output_dir", "output_folder", "reports_folder", "directory", "bundle_directory", "output_directory", "artifact_dir", "artifacts_dir", "artifacts_directory", "folder", "bundle_folder", "root", "report_root", "output_root", "report_output_root", "report_bundle_root", "artifacts_root") or _pick(inputs_report_outputs, "dir", "bundle_dir", "report_dir", "reports_dir", "reports_directory", "report_directory", "output_dir", "report_output_directory", "report_output_dir", "output_folder", "reports_folder", "directory", "bundle_directory", "output_directory", "artifact_dir", "artifacts_dir", "artifacts_directory", "folder", "bundle_folder", "root", "report_root", "output_root", "report_output_root", "report_bundle_root", "artifacts_root") or _pick(scenario_inputs_report_outputs, "dir", "bundle_dir", "report_dir", "reports_dir", "reports_directory", "report_directory", "output_dir", "report_output_directory", "report_output_dir", "output_folder", "reports_folder", "directory", "bundle_directory", "output_directory", "artifact_dir", "artifacts_dir", "artifacts_directory", "folder", "bundle_folder", "root", "report_root", "output_root", "report_output_root", "report_bundle_root", "artifacts_root") or _pick(report_meta, "dir", "bundle_dir", "report_dir", "reports_dir", "reports_directory", "report_directory", "output_dir", "report_output_directory", "report_output_dir", "output_folder", "reports_folder", "directory", "bundle_directory", "output_directory", "artifact_dir", "artifacts_dir", "artifacts_directory", "folder", "bundle_folder", "root", "report_root", "output_root", "report_output_root", "report_bundle_root", "artifacts_root") or _pick(top_level_output_report, "dir", "bundle_dir", "report_dir", "reports_dir", "reports_directory", "report_directory", "output_dir", "report_output_directory", "report_output_dir", "output_folder", "reports_folder", "directory", "bundle_directory", "output_directory", "artifact_dir", "artifacts_dir", "artifacts_directory", "folder", "bundle_folder", "root", "report_root", "output_root", "report_output_root", "report_bundle_root", "artifacts_root") or _pick(inputs_report, "dir", "bundle_dir", "report_dir", "reports_dir", "reports_directory", "report_directory", "output_dir", "report_output_directory", "report_output_dir", "output_folder", "reports_folder", "directory", "bundle_directory", "output_directory", "artifact_dir", "artifacts_dir", "artifacts_directory", "folder", "bundle_folder", "root", "report_root", "output_root", "report_output_root", "report_bundle_root", "artifacts_root") or _pick(scenario_inputs_report, "dir", "bundle_dir", "report_dir", "reports_dir", "reports_directory", "report_directory", "output_dir", "report_output_directory", "report_output_dir", "output_folder", "reports_folder", "directory", "bundle_directory", "output_directory", "artifact_dir", "artifacts_dir", "artifacts_directory", "folder", "bundle_folder", "root", "report_root", "output_root", "report_output_root", "report_bundle_root", "artifacts_root") or _pick(scenario, "report_dir", "reports_dir", "reports_directory", "report_directory", "report_output_directory", "report_output_dir", "report_output_folder", "reports_folder", "report_bundle_dir", "report_bundle_directory", "bundle_dir", "bundle_directory", "report_folder", "report_root", "output_root", "report_output_root", "report_bundle_root", "artifacts_root")
        if args.report_dir:
        ...
        report_basename = _resolve_report_basename(
            report_meta,
            top_level_output_report,
            top_level_output_report_outputs,
            top_level_report_outputs,
            inputs_report,
            scenario_inputs_report,
            scenario=result["scenario"],
        )
        configured_json_path = _pick(report_output_files, "json", "json_path", "json_file", "json_report_path", "report_json", "output_json", "json_report", "json_output", "json_output_file", "output_json_file") or _pick(report_path_files, "json", "json_path", "json_file", "json_report_path", "report_json", "output_json", "json_report", "json_output", "json_output_file", "output_json_file") or _pick(report_download_files, "json", "json_path", "json_file", "json_report_path", "report_json", "output_json", "json_report", "json_output", "json_output_file", "output_json_file") or _pick(top_level_output_report_files, "json", "json_path", "json_file", "json_report_path", "report_json", "output_json", "json_report", "json_output", "json_output_file", "output_json_file") or _pick(top_level_output_report_path_files, "json", "json_path", "json_file", "json_report_path", "report_json", "output_json", "json_report", "json_output", "json_output_file", "output_json_file") or _pick(top_level_output_report_download_files, "json", "json_path", "json_file", "json_report_path", "report_json", "output_json", "json_report", "json_output", "json_output_file", "output_json_file") or _pick(top_level_output_report_output_files, "json", "json_path", "json_file", "json_report_path", "report_json", "output_json", "json_report", "json_output", "json_output_file", "output_json_file") or _pick(top_level_output_report_path_output_files, "json", "json_path", "json_file", "json_report_path", "report_json", "output_json", "json_report", "json_output", "json_output_file", "output_json_file") or _pick(top_level_output_report_download_output_files, "json", "json_path", "json_file", "json_report_path", "report_json", "output_json", "json_report", "json_output", "json_output_file", "output_json_file") or _pick(top_level_report_output_files, "json", "json_path", "json_file", "json_report_path", "report_json", "output_json", "json_report", "json_output", "json_output_file", "output_json_file") or _pick(top_level_report_path_files, "json", "json_path", "json_file", "json_report_path", "report_json", "output_json", "json_report", "json_output", "json_output_file", "output_json_file") or _pick(top_level_report_download_files, "json", "json_path", "json_file", "json_report_path", "report_json", "output_json", "json_report", "json_output", "json_output_file", "output_json_file") or _pick(top_level_direct_report_download_files, "json", "json_path", "json_file", "json_report_path", "report_json", "output_json", "json_report", "json_output", "json_output_file", "output_json_file") or _pick(top_level_direct_report_download_path_files, "json", "json_path", "json_file", "json_report_path", "report_json", "output_json", "json_report", "json_output", "json_output_file", "output_json_file") or _pick(top_level_direct_report_download_download_files, "json", "json_path", "json_file", "json_report_path", "report_json", "output_json", "json_report", "json_output", "json_output_file", "output_json_file") or _pick(inputs_report_output_files, "json", "json_path", "json_file", "json_report_path", "report_json", "output_json", "json_report", "json_output", "json_output_file", "output_json_file") or _pick(inputs_report_path_files, "json", "json_path", "json_file", "json_report_path", "report_json", "output_json", "json_report", "json_output", "json_output_file", "output_json_file") or _pick(inputs_report_download_files, "json", "json_path", "json_file", "json_report_path", "report_json", "output_json", "json_report", "json_output", "json_output_file", "output_json_file") or _pick(scenario_inputs_report_output_files, "json", "json_path", "json_file", "json_report_path", "report_json", "output_json", "json_report", "json_output", "json_output_file", "output_json_file") or _pick(scenario_inputs_report_path_files, "json", "json_path", "json_file", "json_report_path", "report_json", "output_json", "json_report", "json_output", "json_output_file", "output_json_file") or _pick(scenario_inputs_report_download_files, "json", "json_path", "json_file", "json_report_path", "report_json", "output_json", "json_report", "json_output", "json_output_file", "output_json_file") or _pick(report_outputs, "json", "json_path", "json_file", "json_report_path", "report_json", "output_json", "json_report", "json_output", "json_output_file", "output_json_file") or _pick(top_level_output_report_outputs, "json", "json_path", "json_file", "json_report_path", "report_json", "output_json", "json_report", "json_output", "json_output_file", "output_json_file") or _pick(top_level_report_outputs, "json", "json_path", "json_file", "json_report_path", "report_json", "output_json", "json_report", "json_output", "json_output_file", "output_json_file") or _pick(top_level_output_report, "json", "json_path", "json_file", "json_report_path", "report_json", "output_json", "json_report", "json_output", "json_output_file", "output_json_file") or _pick(inputs_report_outputs, "json", "json_path", "json_file", "json_report_path", "report_json", "output_json", "json_report", "json_output", "json_output_file", "output_json_file") or _pick(scenario_inputs_report_outputs, "json", "json_path", "json_file", "json_report_path", "report_json", "output_json", "json_report", "json_output", "json_output_file", "output_json_file") or _pick(report_meta, "json", "json_path", "json_file", "json_report_path", "report_json", "output_json", "json_report", "json_output", "json_output_file", "output_json_file") or _pick(inputs_report, "json", "json_path", "json_file", "json_report_path", "report_json", "output_json", "json_report", "json_output", "json_output_file", "output_json_file") or _pick(scenario_inputs_report, "json", "json_path", "json_file", "json_report_path", "report_json", "output_json", "json_report", "json_output", "json_output_file", "output_json_file") or _pick(scenario, "json_report_path", "report_json_path", "report_json_file", "report_json_output", "report_json_file", "output_json_path", "json_output")
        configured_markdown_path = _pick(report_output_files, "markdown", "markdown_path", "markdown_file", "markdown_report_path", "markdown_location", "md_report", "report_markdown", "output_markdown", "markdown_report", "md", "md_path", "md_file", "markdown_output", "markdown_output_file", "output_markdown_file", "output_md_path", "output_md_file") or _pick(report_path_files, "markdown", "markdown_path", "markdown_file", "markdown_report_path", "markdown_location", "md_report", "report_markdown", "output_markdown", "markdown_report", "md", "md_path", "md_file", "markdown_output", "markdown_output_file", "output_markdown_file", "output_md_path", "output_md_file") or _pick(report_download_files, "markdown", "markdown_path", "markdown_file", "markdown_report_path", "markdown_location", "md_report", "report_markdown", "output_markdown", "markdown_report", "md", "md_path", "md_file", "markdown_output", "markdown_output_file", "output_markdown_file", "output_md_path", "output_md_file") or _pick(top_level_output_report_files, "markdown", "markdown_path", "markdown_file", "markdown_report_path", "markdown_location", "md_report", "report_markdown", "output_markdown", "markdown_report", "md", "md_path", "md_file", "markdown_output", "markdown_output_file", "output_markdown_file", "output_md_path", "output_md_file") or _pick(top_level_output_report_path_files, "markdown", "markdown_path", "markdown_file", "markdown_report_path", "markdown_location", "md_report", "report_markdown", "output_markdown", "markdown_report", "md", "md_path", "md_file", "markdown_output", "markdown_output_file", "output_markdown_file", "output_md_path", "output_md_file") or _pick(top_level_output_report_download_files, "markdown", "markdown_path", "markdown_file", "markdown_report_path", "markdown_location", "md_report", "report_markdown", "output_markdown", "markdown_report", "md", "md_path", "md_file", "markdown_output", "markdown_output_file", "output_markdown_file", "output_md_path", "output_md_file") or _pick(top_level_output_report_output_files, "markdown", "markdown_path", "markdown_file", "markdown_report_path", "markdown_location", "md_report", "report_markdown", "output_markdown", "markdown_report", "md", "md_path", "md_file", "markdown_output", "markdown_output_file", "output_markdown_file", "output_md_path", "output_md_file") or _pick(top_level_output_report_path_output_files, "markdown", "markdown_path", "markdown_file", "markdown_report_path", "markdown_location", "md_report", "report_markdown", "output_markdown", "markdown_report", "md", "md_path", "md_file", "markdown_output", "markdown_output_file", "output_markdown_file", "output_md_path", "output_md_file") or _pick(top_level_output_report_download_output_files, "markdown", "markdown_path", "markdown_file", "markdown_report_path", "markdown_location", "md_report", "report_markdown", "output_markdown", "markdown_report", "md", "md_path", "md_file", "markdown_output", "markdown_output_file", "output_markdown_file", "output_md_path", "output_md_file") or _pick(top_level_report_output_files, "markdown", "markdown_path", "markdown_file", "markdown_report_path", "markdown_location", "md_report", "report_markdown", "output_markdown", "markdown_report", "md", "md_path", "md_file", "markdown_output", "markdown_output_file", "output_markdown_file", "output_md_path", "output_md_file") or _pick(top_level_report_path_files, "markdown", "markdown_path", "markdown_file", "markdown_report_path", "markdown_location", "md_report", "report_markdown", "output_markdown", "markdown_report", "md", "md_path", "md_file", "markdown_output", "markdown_output_file", "output_markdown_file", "output_md_path", "output_md_file") or _pick(top_level_report_download_files, "markdown", "markdown_path", "markdown_file", "markdown_report_path", "markdown_location", "md_report", "report_markdown", "output_markdown", "markdown_report", "md", "md_path", "md_file", "markdown_output", "markdown_output_file", "output_markdown_file", "output_md_path", "output_md_file") or _pick(top_level_direct_report_download_files, "markdown", "markdown_path", "markdown_file", "markdown_report_path", "markdown_location", "md_report", "report_markdown", "output_markdown", "markdown_report", "md", "md_path", "md_file", "markdown_output", "markdown_output_file", "output_markdown_file", "output_md_path", "output_md_file") or _pick(top_level_direct_report_download_path_files, "markdown", "markdown_path", "markdown_file", "markdown_report_path", "markdown_location", "md_report", "report_markdown", "output_markdown", "markdown_report", "md", "md_path", "md_file", "markdown_output", "markdown_output_file", "output_markdown_file", "output_md_path", "output_md_file") or _pick(top_level_direct_report_download_download_files, "markdown", "markdown_path", "markdown_file", "markdown_report_path", "markdown_location", "md_report", "report_markdown", "output_markdown", "markdown_report", "md", "md_path", "md_file", "markdown_output", "markdown_output_file", "output_markdown_file", "output_md_path", "output_md_file") or _pick(inputs_report_output_files, "markdown", "markdown_path", "markdown_file", "markdown_report_path", "markdown_location", "md_report", "report_markdown", "output_markdown", "markdown_report", "md", "md_path", "md_file", "markdown_output", "markdown_output_file", "output_markdown_file", "output_md_path", "output_md_file") or _pick(inputs_report_path_files, "markdown", "markdown_path", "markdown_file", "markdown_report_path", "markdown_location", "md_report", "report_markdown", "output_markdown", "markdown_report", "md", "md_path", "md_file", "markdown_output", "markdown_output_file", "output_markdown_file", "output_md_path", "output_md_file") or _pick(inputs_report_download_files, "markdown", "markdown_path", "markdown_file", "markdown_report_path", "markdown_location", "md_report", "report_markdown", "output_markdown", "markdown_report", "md", "md_path", "md_file", "markdown_output", "markdown_output_file", "output_markdown_file", "output_md_path", "output_md_file") or _pick(scenario_inputs_report_output_files, "markdown", "markdown_path", "markdown_file", "markdown_report_path", "markdown_location", "md_report", "report_markdown", "output_markdown", "markdown_report", "md", "md_path", "md_file", "markdown_output", "markdown_output_file", "output_markdown_file", "output_md_path", "output_md_file") or _pick(scenario_inputs_report_path_files, "markdown", "markdown_path", "markdown_file", "markdown_report_path", "markdown_location", "md_report", "report_markdown", "output_markdown", "markdown_report", "md", "md_path", "md_file", "markdown_output", "markdown_output_file", "output_markdown_file", "output_md_path", "output_md_file") or _pick(scenario_inputs_report_download_files, "markdown", "markdown_path", "markdown_file", "markdown_report_path", "markdown_location", "md_report", "report_markdown", "output_markdown", "markdown_report", "md", "md_path", "md_file", "markdown_output", "markdown_output_file", "output_markdown_file", "output_md_path", "output_md_file") or _pick(report_outputs, "markdown", "markdown_path", "markdown_file", "markdown_report_path", "markdown_location", "md_report", "report_markdown", "output_markdown", "markdown_report", "md", "md_path", "md_file", "markdown_output", "markdown_output_file", "output_markdown_file", "output_md_path", "output_md_file") or _pick(top_level_output_report_outputs, "markdown", "markdown_path", "markdown_file", "markdown_report_path", "markdown_location", "md_report", "report_markdown", "output_markdown", "markdown_report", "md", "md_path", "md_file", "markdown_output", "markdown_output_file", "output_markdown_file", "output_md_path", "output_md_file") or _pick(top_level_report_outputs, "markdown", "markdown_path", "markdown_file", "markdown_report_path", "markdown_location", "md_report", "report_markdown", "output_markdown", "markdown_report", "md", "md_path", "md_file", "markdown_output", "markdown_output_file", "output_markdown_file", "output_md_path", "output_md_file") or _pick(top_level_output_report, "markdown", "markdown_path", "markdown_file", "markdown_report_path", "markdown_location", "md_report", "report_markdown", "output_markdown", "markdown_report", "md", "md_path", "md_file", "markdown_output", "markdown_output_file", "output_markdown_file", "output_md_path", "output_md_file") or _pick(inputs_report_outputs, "markdown", "markdown_path", "markdown_file", "markdown_report_path", "markdown_location", "md_report", "report_markdown", "output_markdown", "markdown_report", "md", "md_path", "md_file", "markdown_output", "markdown_output_file", "output_markdown_file", "output_md_path", "output_md_file") or _pick(scenario_inputs_report_outputs, "markdown", "markdown_path", "markdown_file", "markdown_report_path", "markdown_location", "md_report", "report_markdown", "output_markdown", "markdown_report", "md", "md_path", "md_file", "markdown_output", "markdown_output_file", "output_markdown_file", "output_md_path", "output_md_file") or _pick(report_meta, "markdown", "markdown_path", "markdown_file", "markdown_report_path", "markdown_location", "md_report", "report_markdown", "output_markdown", "markdown_report", "md", "md_path", "md_file", "markdown_output", "markdown_output_file", "output_markdown_file", "output_md_path", "output_md_file") or _pick(inputs_report, "markdown", "markdown_path", "markdown_file", "markdown_report_path", "markdown_location", "md_report", "report_markdown", "output_markdown", "markdown_report", "md", "md_path", "md_file", "markdown_output", "markdown_output_file", "output_markdown_file", "output_md_path", "output_md_file") or _pick(scenario_inputs_report, "markdown", "markdown_path", "markdown_file", "markdown_report_path", "markdown_location", "md_report", "report_markdown", "output_markdown", "markdown_report", "md", "md_path", "md_file", "markdown_output", "markdown_output_file", "output_markdown_file", "output_md_path", "output_md_file") or _pick(scenario, "markdown_report_path", "report_markdown_path", "report_markdown_file", "report_markdown_output", "report_markdown_target", "report_markdown_location", "report_md_output", "report_md_target", "report_markdown_file", "report_md_file", "output_markdown_path", "output_md_path", "output_md_file", "report_md_path", "md_file", "markdown_output")
        configured_html_path = _pick(report_output_files, "html", "html_path", "html_file", "html_report_path", "html_location", "report_html", "output_html", "html_report", "html_output", "html_output_file", "output_html_file") or _pick(report_path_files, "html", "html_path", "html_file", "html_report_path", "html_location", "report_html", "output_html", "html_report", "html_output", "html_output_file", "output_html_file") or _pick(report_download_files, "html", "html_path", "html_file", "html_report_path", "html_location", "report_html", "output_html", "html_report", "html_output", "html_output_file", "output_html_file") or _pick(top_level_output_report_files, "html", "html_path", "html_file", "html_report_path", "html_location", "report_html", "output_html", "html_report", "html_output", "html_output_file", "output_html_file") or _pick(top_level_output_report_path_files, "html", "html_path", "html_file", "html_report_path", "html_location", "report_html", "output_html", "html_report", "html_output", "html_output_file", "output_html_file") or _pick(top_level_output_report_download_files, "html", "html_path", "html_file", "html_report_path", "html_location", "report_html", "output_html", "html_report", "html_output", "html_output_file", "output_html_file") or _pick(top_level_output_report_output_files, "html", "html_path", "html_file", "html_report_path", "html_location", "report_html", "output_html", "html_report", "html_output", "html_output_file", "output_html_file") or _pick(top_level_output_report_path_output_files, "html", "html_path", "html_file", "html_report_path", "html_location", "report_html", "output_html", "html_report", "html_output", "html_output_file", "output_html_file") or _pick(top_level_output_report_download_output_files, "html", "html_path", "html_file", "html_report_path", "html_location", "report_html", "output_html", "html_report", "html_output", "html_output_file", "output_html_file") or _pick(top_level_report_output_files, "html", "html_path", "html_file", "html_report_path", "html_location", "report_html", "output_html", "html_report", "html_output", "html_output_file", "output_html_file") or _pick(top_level_report_path_files, "html", "html_path", "html_file", "html_report_path", "html_location", "report_html", "output_html", "html_report", "html_output", "html_output_file", "output_html_file") or _pick(top_level_report_download_files, "html", "html_path", "html_file", "html_report_path", "html_location", "report_html", "output_html", "html_report", "html_output", "html_output_file", "output_html_file") or _pick(top_level_direct_report_download_files, "html", "html_path", "html_file", "html_report_path", "html_location", "report_html", "output_html", "html_report", "html_output", "html_output_file", "output_html_file") or _pick(top_level_direct_report_download_path_files, "html", "html_path", "html_file", "html_report_path", "html_location", "report_html", "output_html", "html_report", "html_output", "html_output_file", "output_html_file") or _pick(top_level_direct_report_download_download_files, "html", "html_path", "html_file", "html_report_path", "html_location", "report_html", "output_html", "html_report", "html_output", "html_output_file", "output_html_file") or _pick(inputs_report_output_files, "html", "html_path", "html_file", "html_report_path", "html_location", "report_html", "output_html", "html_report", "html_output", "html_output_file", "output_html_file") or _pick(inputs_report_path_files, "html", "html_path", "html_file", "html_report_path", "html_location", "report_html", "output_html", "html_report", "html_output", "html_output_file", "output_html_file") or _pick(inputs_report_download_files, "html", "html_path", "html_file", "html_report_path", "html_location", "report_html", "output_html", "html_report", "html_output", "html_output_file", "output_html_file") or _pick(scenario_inputs_report_output_files, "html", "html_path", "html_file", "html_report_path", "html_location", "report_html", "output_html", "html_report", "html_output", "html_output_file", "output_html_file") or _pick(scenario_inputs_report_path_files, "html", "html_path", "html_file", "html_report_path", "html_location", "report_html", "output_html", "html_report", "html_output", "html_output_file", "output_html_file") or _pick(scenario_inputs_report_download_files, "html", "html_path", "html_file", "html_report_path", "html_location", "report_html", "output_html", "html_report", "html_output", "html_output_file", "output_html_file") or _pick(report_outputs, "html", "html_path", "html_file", "html_report_path", "html_location", "report_html", "output_html", "html_report", "html_output", "html_output_file", "output_html_file") or _pick(top_level_output_report_outputs, "html", "html_path", "html_file", "html_report_path", "html_location", "report_html", "output_html", "html_report", "html_output", "html_output_file", "output_html_file") or _pick(top_level_report_outputs, "html", "html_path", "html_file", "html_report_path", "html_location", "report_html", "output_html", "html_report", "html_output", "html_output_file", "output_html_file") or _pick(top_level_output_report, "html", "html_path", "html_file", "html_report_path", "html_location", "report_html", "output_html", "html_report", "html_output", "html_output_file", "output_html_file") or _pick(inputs_report_outputs, "html", "html_path", "html_file", "html_report_path", "html_location", "report_html", "output_html", "html_report", "html_output", "html_output_file", "output_html_file") or _pick(scenario_inputs_report_outputs, "html", "html_path", "html_file", "html_report_path", "html_location", "report_html", "output_html", "html_report", "html_output", "html_output_file", "output_html_file") or _pick(report_meta, "html", "html_path", "html_file", "html_report_path", "html_location", "report_html", "output_html", "html_report", "html_output", "html_output_file", "output_html_file") or _pick(inputs_report, "html", "html_path", "html_file", "html_report_path", "html_location", "report_html", "output_html", "html_report", "html_output", "html_output_file", "output_html_file") or _pick(scenario_inputs_report, "html", "html_path", "html_file", "html_report_path", "html_location", "report_html", "output_html", "html_report", "html_output", "html_output_file", "output_html_file") or _pick(scenario, "html_report_path", "report_html_path", "report_html_file", "report_html_output", "report_html_target", "report_html_location", "report_html_file", "output_html_path", "html_output")
