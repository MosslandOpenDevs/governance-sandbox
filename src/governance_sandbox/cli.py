...
def main() -> None:
    ...
    if args.command == "run":
        ...
        result["scenario"] = {
            ...
            "report_audience": ", ".join(_normalize_string_list(_pick(report_meta, "audience", "audiences", "reader", "readers", "reviewer", "reviewers", "viewer", "viewers", "watcher", "watchers", "target", "targets", "report_audience", "report_audiences", "report_reader", "report_readers", "report_reviewer", "report_reviewers", "report_viewer", "report_viewers", "report_watcher", "report_watchers", "report_target", "report_targets") or _pick(inputs_report, "audience", "audiences", "reader", "readers", "reviewer", "reviewers", "viewer", "viewers", "watcher", "watchers", "target", "targets", "report_audience", "report_audiences", "report_reader", "report_readers", "report_reviewer", "report_reviewers", "report_viewer", "report_viewers", "report_watcher", "report_watchers", "report_target", "report_targets") or _pick(scenario_inputs_report, "audience", "audiences", "reader", "readers", "reviewer", "reviewers", "viewer", "viewers", "watcher", "watchers", "target", "targets", "report_audience", "report_audiences", "report_reader", "report_readers", "report_reviewer", "report_reviewers", "report_viewer", "report_viewers", "report_watcher", "report_watchers", "report_target", "report_targets") or _pick(scenario, "report_audience", "report_audiences", "report_reader", "report_readers", "report_reviewer", "report_reviewers", "report_viewer", "report_viewers", "report_watcher", "report_watchers", "report_target", "report_targets", "audience", "audiences", "reader", "reviewer", "viewer", "watcher", "watchers", "target") or _pick(scenario_meta, "report_audience", "report_audiences", "report_reader", "report_readers", "report_reviewer", "report_reviewers", "report_viewer", "report_viewers", "report_watcher", "report_watchers", "report_target", "report_targets", "audience", "audiences", "reader", "reviewer", "viewer", "watcher", "watchers", "target"))) or None,
