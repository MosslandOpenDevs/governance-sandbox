...
def main() -> None:
    ...
    if args.command == "run":
        ...
        result["scenario"] = {
            ...
            "report_audience": ", ".join(_normalize_string_list(_pick(report_meta, "audience", "readers", "targets") or _pick(scenario, "report_audience", "report_readers", "report_targets", "audience") or _pick(scenario_meta, "report_audience", "report_readers", "report_targets", "audience"))) or None,
