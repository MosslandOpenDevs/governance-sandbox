...
def _resolve_report_basename(*report_sections: dict[str, Any], scenario: dict[str, Any]) -> str:
    for report_meta in report_sections:
        ...
        configured = _pick(report_outputs, "basename", "bundle_basename", "bundle_name", "bundle_stem", "bundle_id", "bundle_label", "bundle_title", "base_name", "file_basename", "file_stem", "stem", "output_basename", "output_name", "output_slug", "output_label", "label", "bundle_slug", "report_slug", "report_name_slug", "base", "slug", "name") or _pick(report_meta, "basename", "bundle_basename", "bundle_name", "bundle_stem", "bundle_id", "bundle_label", "bundle_title", "base_name", "file_basename", "file_stem", "stem", "output_basename", "output_name", "output_slug", "output_label", "label", "bundle_slug", "report_slug", "report_name_slug", "base", "slug", "name")
        if configured:
            return _slugify_report_basename(str(configured))
    configured = _pick(scenario, "report_basename", "report_file_stem", "report_stem", "report_name", "report_slug", "report_name_slug", "report_base", "report_bundle_label", "report_bundle_title")
    if configured:
        return _slugify_report_basename(str(configured))
    titled = next((
...
def main() -> None:
    ...
    if args.command == "run":
        ...
        proposal = _normalize_proposal(args.proposal) or _normalize_proposal(_pick(scenario, "proposal", "proposal_text", "proposal_markdown", "proposal_body", "proposal_body_markdown", "proposal_outline", "proposal_notes", "proposal_details", "proposal_copy", "proposal_copy_markdown", "proposal_copy_md", "prompt")) or _normalize_proposal(_pick(inputs, "proposal", "proposal_text", "proposal_markdown", "proposal_body", "proposal_body_markdown", "proposal_outline", "proposal_notes", "proposal_details", "proposal_copy", "proposal_copy_markdown", "proposal_copy_md", "prompt")) or _normalize_proposal(_pick(scenario_inputs, "proposal", "proposal_text", "proposal_markdown", "proposal_body", "proposal_body_markdown", "proposal_outline", "proposal_notes", "proposal_details", "proposal_copy", "proposal_copy_markdown", "proposal_copy_md", "prompt")) or _normalize_proposal_from_mapping(scenario) or _normalize_proposal_from_mapping(inputs) or _normalize_proposal_from_mapping(scenario_inputs)
        ...
        result["scenario"] = {
            ...
            "report_reviewers": ", ".join(_normalize_string_list(_pick(report_meta, "reviewers", "reviewer", "review_team", "review_teams", "report_reviewers", "report_reviewer", "report_review_team", "report_review_teams") or _pick(inputs_report, "reviewers", "reviewer", "review_team", "review_teams", "report_reviewers", "report_reviewer", "report_review_team", "report_review_teams") or _pick(scenario_inputs_report, "reviewers", "reviewer", "review_team", "review_teams", "report_reviewers", "report_reviewer", "report_review_team", "report_review_teams") or _pick(scenario, "report_reviewers", "report_reviewer", "report_review_team", "report_review_teams", "reviewers", "reviewer", "review_team", "review_teams") or _pick(scenario_meta, "report_reviewers", "report_reviewer", "report_review_team", "report_review_teams", "reviewers", "reviewer", "review_team", "review_teams"))) or None,
        ...
        configured_report_dir = _pick(report_outputs, "dir", "bundle_dir", "report_dir", "reports_dir", "report_directory", "output_dir", "report_output_directory", "report_output_dir", "output_folder", "reports_folder", "directory", "output_directory", "folder", "bundle_folder", "root", "report_root", "output_root", "report_output_root", "report_bundle_root", "artifacts_root") or _pick(top_level_output_report_outputs, "dir", "bundle_dir", "report_dir", "reports_dir", "report_directory", "output_dir", "report_output_directory", "report_output_dir", "output_folder", "reports_folder", "directory", "output_directory", "folder", "bundle_folder", "root", "report_root", "output_root", "report_output_root", "report_bundle_root", "artifacts_root") or _pick(top_level_report_outputs, "dir", "bundle_dir", "report_dir", "reports_dir", "report_directory", "output_dir", "report_output_directory", "report_output_dir", "output_folder", "reports_folder", "directory", "output_directory", "folder", "bundle_folder", "root", "report_root", "output_root", "report_output_root", "report_bundle_root", "artifacts_root") or _pick(inputs_report_outputs, "dir", "bundle_dir", "report_dir", "reports_dir", "report_directory", "output_dir", "report_output_directory", "report_output_dir", "output_folder", "reports_folder", "directory", "output_directory", "folder", "bundle_folder", "root", "report_root", "output_root", "report_output_root", "report_bundle_root", "artifacts_root") or _pick(scenario_inputs_report_outputs, "dir", "bundle_dir", "report_dir", "reports_dir", "report_directory", "output_dir", "report_output_directory", "report_output_dir", "output_folder", "reports_folder", "directory", "output_directory", "folder", "bundle_folder", "root", "report_root", "output_root", "report_output_root", "report_bundle_root", "artifacts_root") or _pick(report_meta, "dir", "bundle_dir", "report_dir", "reports_dir", "report_directory", "output_dir", "report_output_directory", "report_output_dir", "output_folder", "reports_folder", "directory", "output_directory", "folder", "bundle_folder", "root", "report_root", "output_root", "report_output_root", "report_bundle_root", "artifacts_root") or _pick(top_level_output_report, "dir", "bundle_dir", "report_dir", "reports_dir", "report_directory", "output_dir", "report_output_directory", "report_output_dir", "output_folder", "reports_folder", "directory", "output_directory", "folder", "bundle_folder", "root", "report_root", "output_root", "report_output_root", "report_bundle_root", "artifacts_root") or _pick(inputs_report, "dir", "bundle_dir", "report_dir", "reports_dir", "report_directory", "output_dir", "report_output_directory", "report_output_dir", "output_folder", "reports_folder", "directory", "output_directory", "folder", "bundle_folder", "root", "report_root", "output_root", "report_output_root", "report_bundle_root", "artifacts_root") or _pick(scenario_inputs_report, "dir", "bundle_dir", "report_dir", "reports_dir", "report_directory", "output_dir", "report_output_directory", "report_output_dir", "output_folder", "reports_folder", "directory", "output_directory", "folder", "bundle_folder", "root", "report_root", "output_root", "report_output_root", "report_bundle_root", "artifacts_root") or _pick(scenario, "report_dir", "reports_dir", "report_directory", "report_output_directory", "report_output_dir", "report_output_folder", "reports_folder", "report_bundle_dir", "report_bundle_directory", "bundle_dir", "report_folder", "report_root", "output_root", "report_output_root", "report_bundle_root", "artifacts_root")
        if args.report_dir:
