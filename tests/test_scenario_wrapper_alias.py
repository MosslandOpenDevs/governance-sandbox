...
class ScenarioWrapperAliasTest(unittest.TestCase):
    def test_run_accepts_top_level_scenario_payload_wrapper(self) -> None:
        with tempfile.TemporaryDirectory() as tmpdir:
                ...
                json.dumps(
                    {
                        "scenario_payload": {
                            ...
                            "report": {
                                ...
                                "summary": "Wrapper alias proving scenario file import plus report metadata handoff.",
                            },
                        }
                    }
                ),
            ...
            self.assertEqual(
                ...
                "Wrapper alias proving scenario file import plus report metadata handoff.",
            )
