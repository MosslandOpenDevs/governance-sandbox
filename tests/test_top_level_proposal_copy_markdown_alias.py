...
class TopLevelProposalCopyMarkdownAliasTests(unittest.TestCase):
    def test_cli_accepts_top_level_proposal_copy_markdown_alias(self) -> None:
        with tempfile.TemporaryDirectory() as tmpdir:
            scenario = Path(tmpdir) / "scenario.json"
            scenario.write_text(json.dumps({
                "proposal_copy_markdown": "## Budget\n- Cap spend",
