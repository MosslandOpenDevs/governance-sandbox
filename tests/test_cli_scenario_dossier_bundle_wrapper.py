...
class ScenarioDossierBundleWrapperTests(unittest.TestCase):
    def test_scenario_dossier_bundle_wrapper_loads_proposal_and_stakeholders(self) -> None:
        repo_root = Path(__file__).resolve().parents[1]
        payload = {
            "scenario_dossier_bundle": {
                "proposal": {
                    "title": "Treasury guardrails",
                    "summary": "Ship monthly disclosure pack.",
                },
                "stakeholders": [
